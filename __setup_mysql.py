...
try:
    ...
    cursor.execute("""CREATE TABLE cc_hits (
        ...
        esp_14 int(10) unsigned NOT NULL default '0',
        esp_18 int(10) unsigned NOT NULL default '0',
        esp_1c int(10) unsigned NOT NULL default '0',
        esp_20 int(10) unsigned NOT NULL default '0',
        ...
        esp_14_deref text NOT NULL,
        esp_18_deref text NOT NULL,
        esp_1c_deref text NOT NULL,
        esp_20_deref text NOT NULL,
